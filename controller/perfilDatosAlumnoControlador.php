...
$comentarios = $comentariosDAO->comentariosDeAlumno($_SESSION["correoActual"]);

$dao->reInsertCon();
$cantTerminados = $dao->cantCursosTerminados($correo);
$dao->reInsertCon();
$cantComprados = $dao->cantCursosComprados($correo);
