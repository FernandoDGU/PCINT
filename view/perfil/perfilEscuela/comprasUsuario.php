<?php
session_start();
require_once "../../../controller/perfilComprasEscuelaControlador.php"
?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div id="userPurchases" class="col-md-9 col-lg-10 full-pageScroll-bar text-center jsc-account">
                ...
                <?php foreach ($cursosEscuelaPrecios as $curso) { ?>
                    <hr>
                    <div class="row">
                        <div class="col-lg-2 col-sm-6 mx-auto d-flex flex-column justify-content-center align-items-center">
                            ...
                            <br>
                            <button id="btn-modifyCourse" class="btn btn-warning btn-scale" onclick="enseñarDatosCursos(<?php echo $curso["id_curso"]; ?>)">Modificar</button>
                            <br>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-12 text-center d-flex flex-column justify-content-center align-items-center">
                            ...
                            <h3><strong>$<?php echo $curso["Ganancias"]; ?></strong></h3>
                        </div>
                    </div>
                    <hr>
                <?php } ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-warning text-white">
                    <h5 class="modal-title " id="modifyCourseLabel">Modificando...</h5>
                </div>
                <form id="modif-CourseForm" action="comprasUsuario.php" enctype="multipart/form-data">
                    <input type="text" id="idModifCurso" name="idModifCurso" style="display:none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="input-group mt-3">
                                        <span class="input-group-text col-lg-2 col-12" id="basic-addon1"><i class="fas fa-graduation-cap"></i>&nbsp;Nombre
                                            del
                                            curso</span>
                                        <input type="text" name="nameCourseM" id="nameCourseM" class="form-control" placeholder="Máximo 30 carácteres" aria-label="Username" aria-describedby="basic-addon1" onfocusout="checkLength(this, '#error-nameCourseM', 31)" value="Lorem ipsum dolor sit amet.">
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="input-group mt-5">
                                        ...
                                        <input id="sDescriptionCourseM" name="sDescriptionCourseM" type="text" class="form-control" placeholder="Máximo 50 carácteres" aria-label="Username" aria-describedby="basic-addon1" onfocusout="checkLength(this, '#error-sDescriptionCourseM', 51)" value="Lorem ipsum, dolor sit amet consectetur adipisicing elit.">
                ...
                <div class="modal-footer ">
                    ...
                    <button id="btn-modifyCourse2" type="button" class="btn btn-warning mx-auto d-flex">Modificar
                        curso</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="loadingMessage-body">
                    ...
                    <div class="progressLoading">
                        <div class="progress-done-loading" style="width: 0px;">
                            <!--100% = width:300px;-->
                            0%
                        </div>
                    </div>
