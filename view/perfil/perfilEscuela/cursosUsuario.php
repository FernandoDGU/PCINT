<?php
session_start();
require_once "../../../controller/cursosPerfilControlador.php"
?>
...
<body>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div id="userCourses" class="col-md-9 col-lg-10 full-pageScroll-bar text-center jsc-account">
                ...
                <hr>
                <div class="">
                    <?php foreach ($cursosEscuela as $c) {

                        if ($c["Votos Totales"] != 0)
                            $porcentajeVotos = ($c["puntaje"] / $c["Votos Totales"]) * 100;
                    ?>
                        <div class="row ">

                            <a class="col-lg-2 col-sm-6 mx-auto d-flex flex-column justify-content-center align-items-center" href="../../muestraCurso.php?id=<?php echo $c["id_curso"]; ?>">
                                <div class="betterImages">
                                    <img src="../../../controller/showCourseImage.php?id=<?php echo $c["id_curso"]; ?>" onclick='window.location.href="../../muestraCurso.php?cap=1&id=<?php echo $c["id_curso"]; ?>";'>
                                </div>
                            </a>
                            ...
                            <div class="col-lg-4 col-sm-12 text-center d-flex flex-column justify-content-center align-items-center">
                                <?php if ($c["Votos Totales"] != 0) {
                                    if ($porcentajeVotos > 60) { ?>
                                        <div class="row"><i class="fas fa-thumbs-up fa-5x" style="color:blue;"></i></div>
                                    <?php } else { ?>
                                        <div class="row"><i class="fas fa-thumbs-down fa-5x" style="color:red;"></i></div>
                                    <?php } ?>
                                    <div class="row text-center">
                                        <p>Porcentaje de votos positivos: </p>
                                        <strong><?php echo round($porcentajeVotos); ?>%</strong>
                                    </div>
                                <?php } else { ?>
                                    <div class="row text-center">
                                        <i class="fas fa-question-circle fa-5x"></i>
                                        <strong>El curso <i>aún</i> no tiene votos. </strong>
                                    </div>
                                <?php } ?>
                            </div>
