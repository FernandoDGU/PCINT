    ...
    ?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <div class="container-fluid">
                <a class="navbar-brand" href="Home.html"><strong>MediaCourse</strong></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mx-auto d-flex mb-2 mb-lg-0 text-center" id="navMainMenu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#"><i class="fas fa-home"></i> <br>
                                Inicio</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="row">
            <div class="col-12">
                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                    ...
                    <label id="btn-punctuation" class="btn btn-outline-primary btn-scale" for="btnradio1">Mejor
                        Puntuación</label>

                    <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off">
                    <label id="btn-bestSelled" class="btn btn-outline-primary btn-scale" for="btnradio2">Más
                        vendidos</label>

                    <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off">
                    <label id="btn-category" class="btn btn-outline-primary btn-scale" for="btnradio3">Categorías</label>
                </div>
                <div class="col-12 mt-3">
                    <div class="scrollmenu" style="display:none;">
                        <a class="" href="javascript:void(0)">Python</a>
                        <a class="" href="javascript:void(0)">Machine Learning</a>
                        <a class="" href="javascript:void(0)">Unreal Engine</a>
                        <a class="" href="javascript:void(0)">Data Structures</a>
                        <a class="" href="javascript:void(0)">C#</a>
                        <a class="" href="javascript:void(0)">Java</a>
                        <a class="" href="javascript:void(0)">Object Oriented Programming</a>
                        <a class="" href="javascript:void(0)">Arduino</a>
                        <a class="" href="javascript:void(0)">Blender</a>
                        <a class="" href="javascript:void(0)">Maya</a>
                        <a class="" href="javascript:void(0)">Big Data</a>
                        <a class="" href="javascript:void(0)">SQL</a>
                        <a class="" href="javascript:void(0)">HTML</a>
                        <a class="" href="javascript:void(0)">JavaScript</a>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="multiple-items text-center" id="Slides">
                    ...
                    <div class="card" style="width: 18rem;">
                        <img src=" https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbHw6YeSzf-idUinw7gLeDwytixwhAVDNvhw&usqp=CAU" class="card-img-top cursor-denied" alt="..." tabindex="0" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-trigger="hover focus" data-bs-content="Debes iniciar sesión para ver los detalles.">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                of
                                the
                        ...
                        <span class="cursor-pointer" style="color: rgb(0, 0, 167);" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Un 80% de las calificaciones fueron positivas">Este curso tiene más votos
                            positivos</span>
                    </div>
                    <div class="card" style="width: 18rem;">
                        <img src="https://i2.wp.com/unaaldia.hispasec.com/wp-content/uploads/2020/07/1-CrK1VuTTMSg-zL9-z3ohQQ.png?fit=768%2C432&ssl=1" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                of
                                the
                        ...
                        <span class="cursor-pointer" style="color: rgb(255, 136, 0);" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Un 63% de las calificaciones fueron positivas">Este curso tiene votos
                            variados</span>
                    </div>
                    <div class="card" style="width: 18rem;">
                        <img src="https://edteam-media.s3.amazonaws.com/courses/big/85d3d7e4-19db-4cff-a4cb-cbead813b6b5.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                of
                                the
                        ...
                        <i class="glyphicon glyphicon-thumbs-up" style="color:blue;"></i>
                        <span style="color: blue;">Mayormente positiva</span>
                    </div>
                    <div class="card" style="width: 18rem;">
                        <img src=" https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbHw6YeSzf-idUinw7gLeDwytixwhAVDNvhw&usqp=CAU" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                of
                                the
                        ...
                        <i class="glyphicon glyphicon-thumbs-up" style="color:red; transform: scaleX(-1);transform: rotate(180deg);"></i>
                        <span style="color: red;">Mayormente negativa</span>
                    </div>
                    <div class="card" style="width: 18rem;">
                        <img src="https://i2.wp.com/unaaldia.hispasec.com/wp-content/uploads/2020/07/1-CrK1VuTTMSg-zL9-z3ohQQ.png?fit=768%2C432&ssl=1" class="card-img-top" alt="...">
                        <div class="card-body">
